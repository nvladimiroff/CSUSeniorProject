...
<html lang="en" class="ie8 no-js">
  ...
  <html lang="en" class="ie9 no-js">
    ...
    <html lang="en">
      ...
      <head>
        <meta charset="utf-8" />
        <title>What's Cookin | Home</title>
                      ...
                      <div class="col-md-10 col-sm-offset-1">
                        <div class="portlet light" id="rPortlet">
                          ...
                          <div class="portlet-body form">
                            <!-- BEGIN FORM-->
                            <form action="#" class="horizontal-form" id="ingredient_form" onsubmit="return false;">
                              <div class="form-body">
                                <h3 class="form-section">Ingredients</h3>
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label class="control-label">Proteins</label><br>
                                      <input type="text" class="form-control" id="proteins" name="proteins" data-role="tagsinput">
                                      <span class="help-block"> E.g: Poultry, Fish, Beef</span>
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label class="control-label">Dairy</label><br>
                                      <input type="text" class="form-control" id="dairy" name="dairy" data-role="tagsinput">
                                      <span class="help-block"> E.g: Yogurt, Cheese, Milk </span>
                                    </div>
                                  </div>
                                </div>
                                <!--/row-->
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label class="control-label">Vegetable</label><br>
                                      <input type="text" class="form-control" id="vegetables" name="vegetables" data-role="tagsinput">
                                      <span class="help-block"> E.g: Broccoli, Carrots, Celery</span>
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label class="control-label">Fruit</label><br>
                                      <input type="text" class="form-control" id="fruits" name="fruits" data-role="tagsinput">
                                      <span class="help-block"> E.g: Apples, Bananas, Orange</span>
                                    </div>
                                  </div>
                                </div>
                                <!--/row-->
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label class="control-label">Carbohydrates</label><br>
                                      <input type="text" class="form-control" id="carbohydrates" name="carbohydrates" data-role="tagsinput">
                                      <span class="help-block"> E.g: Pasta, Bread, Cereal</span>
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label class="control-label">Miscellaneous</label><br>
                                      <input type="text" class="form-control" id="misc" name="misc" data-role="tagsinput">
                                      <span class="help-block"> Additional ingredient onhand to include. </span>
                                    </div>
                                  </div>
                                </div>
                                <!--/row-->
                                ...
                                <div class="row">
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="origins" name="origins" data-role="tagsinput">
                                      <span class="help-block"> E.g: Mexican, Indian, Tai </span>
                                    </div>
                                  </div>
                                  <!--/span-->
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="spices" name="spices" data-role="tagsinput" >
                                      <span class="help-block">E.g: Salt, Pepper</span>
                                    </div>
                                  </div>
                                  <!--/span-->
                                </div>
                                <!--/row-->
                                <h3 class="form-section">Dietary and Nutritional Information</h3>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="form-group form-md-checkboxes">
                                      <label>Health Preferences</label>
                                      <div class="md-checkbox-inline" id="hCheckboxes"></div>
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="form-group form-md-checkboxes">
                                      ...
                                      <div class="md-checkbox-inline" id="dCheckboxes"></div>
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col-md-12">
                                    <div class="form-group">
                                      <label class="col-md-3 control-label">Calorie Range</label><br>
                                      <div class="col-md-12">
                                        <input id="calorie_range" type="text" value="" />
                                        <span class="help-block"> Select your calorie range or leave at 0 </span>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class="form-actions">
                                <div class="row">
                                  <div class="col-md-offset-10 col-md-6">
                                    <input type="submit" class="btn green" value="Search" id="search">
                                  </div>
                                </div>
                              </div>
                            </form>
